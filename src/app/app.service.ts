...
export class AppService {
  ...
  getLlantas(): any {
    return this.http.get(this.apiUrl + 'api/llantas');
    // return this.http.get('https://tiredirectb2b.com.mx/wbsTDApp/General/datas?UserID=1850&Password=AMN990121B-E2%');
  }

  getPrueba(): any {
    return this.http.get(this.apiUrl + 'api/prueba');
  }
